...
よって、表に書いた通り, **3個の整数の中からいくつか選ぶ方法は $2^3 = 8$ 通り**存在します。一般に $N$ 個のものからいくつか選ぶ方法は $2^N$ 通り存在することが知られています。
...
$N$ 個の整数の中からいくつかの整数を選ぶ方法は $2^N$ 通りあるので、bit全探索が使えます。また、制約を見ると、 $N \leq 16$ なので最悪でも $2^{16} = 65536$ 通りあります。よって、bit全探索でも余裕を持って求めることができます。
